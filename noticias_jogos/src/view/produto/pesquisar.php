<?php
    ...
    $result_pesquisa = "SELECT * FROM tbprod001 WHERE cNmproduto LIKE '%$pesquisar%' LIMIT 20";
                        ...
                        <div class="card mb-0">
                            <div class="project m-0">
                                <figure class="portfolio-item">
                                    ...
                                    <?php echo '<img class="img-responsive mx-auto d-block" src="../edição_dados_admin/upload/'.$rows_pesquisa['cImagem'].'" style="width: 210px; height: 210px;" alt="Imagem">';?>
                                        <div class="overlay">
                                            <div class="hovereffect-title project-icons">
                                                <a href="../produto/vitrine.php?nCdProduto=<?php echo $rows_pesquisa['nCdProduto'];?>" data-toggle="modal" data-target=".project-modal2"><i class="fas fa-angle-double-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </figure>
                            ...
                            <div class="card-body" style="height: 180px;" >
                                <a style="text-decoration: none;" class="card-title title-link fs-20 fw-bold text-uppercase"  href="../produto/vitrine.php?nCdProduto=<?php echo $rows_pesquisa['nCdProduto'];?>"><?php echo $rows_pesquisa['cNmproduto']; ?></a>
                                <p class="card-text text-dark mt-3 mb-0 fs-20" ><?php echo'R$' .number_format($rows_pesquisa['nPreco'],2,',','.').  '<br/>';?></p>
                                <!--coloca as categorias no card-->
                            </div>

                            <div class="card-footer text-center">
                                <p class="card-text mt-2 mb-0 "><a href="../produto/vitrine.php?nCdProduto=<?php echo $rows_pesquisa['nCdProduto']; ?>" class="btn btn-outline-dark ">Acessar</a></p> 
                            </div>
                        </div>
                    </li>
                    <?php } ?>
