...
<?php
    ...
    //$categoria01 = $_POST['categoria1'];

    $categoria02 = $_POST['categoria2'];
    $result_categoria02 = "SELECT * FROM tbprod001 WHERE cNmNivel2 LIKE '%$categoria02%'";
    $resultado_categoria02 = mysqli_query($conn, $result_categoria02);
    //$result_categoria02 = "SELECT DISTINCT cNmNivel2 FROM TBPROD001 WHERE cNmNivel1 = '%$categoria01%'";
?>
        ...
        <div class="container">
            ...
            <div class="mx-auto col-md-10 col-lg-8 branco">
                <ul class="row portfolio lightbox list-unstyled mb-0 shuffle boxed-portfolio" id="grid" >
                    ...
                    <?php 
                    while($rows_categoria02 = mysqli_fetch_array($resultado_categoria02)) {?>
                                    ...
                                    <?php echo '<img class="img-responsive mx-auto d-block" src="/noticias_jogos/src/view/edição_dados_admin/upload/'.$rows_categoria02['cImagem'].'" style="width: 210px; height: 210px;" alt="Imagem">';?>
                                        ...
                                        <div class="overlay">
                                            <div class="hovereffect-title project-icons">
                                                <a href="../produto/vitrine.php?nCdProduto=<?php echo $rows_categoria02['nCdProduto'];?>" data-toggle="modal" data-target=".project-modal2"><i class="fas fa-angle-double-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </figure>
